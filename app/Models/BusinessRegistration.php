...
class BusinessRegistration extends Model
{
    ...
    'company_name', 'entity_type', 'registered_address', 'contact_person_designation',
    'gst_number', 'pan_number', 'tan_number', 'esic_number', 'pf_code',
    'msme_registered', 'pan_aadhar_seeded', 'bank_name', 'account_number', 'ifsc_code', 'account_type',
