...
<body class="flex bg-gray-100 text-gray-800">
  ...
  <aside class="w-64 h-screen bg-gray-900 text-white flex flex-col" 
        x-data="{ sections: { admin: true, category: false, users: false } }">
    <div class="text-2xl font-bold px-6 py-4 border-b border-gray-700">BuildOX</div>

    <nav class="flex-1 px-4 py-6">
      <!-- Dashboard Link -->
      <a href="{{ route('admin_dashboard') }}" class="flex items-center px-3 py-2 mb-2 bg-blue-600 rounded text-white font-semibold">
        <span class="material-icons mr-2">dashboard</span> Dashboard
      </a>

      <!-- Vendor Dropdown -->
      <div class="mt-4">
        <button @click="sections.admin = !sections.admin" class="w-full flex justify-between items-center px-3 py-2 text-left hover:bg-gray-800 rounded">
      ...
      <!-- Category Dropdown -->
      <div class="mt-4">
        <button @click="sections.category = !sections.category" class="w-full flex justify-between items-center px-3 py-2 text-left hover:bg-gray-800 rounded">
      ...
      <!-- Users Dropdown -->
      <div class="mt-6">
        <button @click="sections.users = !sections.users" class="w-full flex justify-between items-center px-3 py-2 text-left hover:bg-gray-800 rounded">
